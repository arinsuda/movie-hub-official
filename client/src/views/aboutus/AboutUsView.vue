<template>
  <div class="about-page">
    ...
    <section class="hero">
      ...
      <p class="hero-sub">
        <!-- TODO: แก้ tagline ของโปรเจกต์ -->
        พื้นที่สำหรับคนรักหนังและซีรีส์ ค้นหา รีวิว และติดตามสิ่งที่คุณดู
        ในที่เดียว
      </p>
    </section>
    ...
    <section class="block">
      ...
      <p class="block-text">
        <!-- TODO: เล่าเรื่องราว/แรงบันดาลใจของโปรเจกต์นี้ -->
        REMOV เริ่มต้นจาก [ใส่เรื่องราวของคุณที่นี่] เราอยากสร้างแพลตฟอร์ม
        ที่ช่วยให้คนดูหนังจดบันทึกสิ่งที่ดู เขียนรีวิว และค้นพบหนังเรื่องใหม่ๆ
        ได้ง่ายขึ้น
      </p>
    </section>
